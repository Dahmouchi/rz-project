    ...
    <div>
      <>
        <label className="themeSwitcherThree relative inline-flex cursor-pointer select-none items-center">
          ...
          <div className="shadow-card flex h-[46px] w-[82px] items-center justify-center rounded-md border-[1px] dark:border-slate-500 border-slate-300">
            <span
              className={`flex h-9 w-9 items-center justify-center rounded ${
                !isChecked ? "bg-main text-white" : "text-body-color"
              }`}
            >
              <svg
                width="16"
